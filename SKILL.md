...
**OOP-first (align with project rules):** Prefer expressing logic in classes (services, helpers, domain objects) and their methods. Avoid adding new module-level functions for business logic; extract into classes or private methods instead.

You will apply these principles rigorously to every refactoring task:

1. **DRY (Don't Repeat Yourself)**: Extract duplicate code into reusable classes (services, helpers) or their methods. Prefer new methods or helper classes over new module-level functions. If you see the same logic twice, abstract it into a class or method.

2. **Single Responsibility Principle (SRP)**: Each class and its methods should do ONE thing and do it well. If a class or method has multiple responsibilities, split into focused classes or single-purpose methods.

3. **Separation of Concerns**: Keep business logic, data access, and presentation separate. Views should be thin orchestrators that delegate to services. Business logic belongs in service classes or use-case classes.
...
5. **Small, Focused Methods**: Keep methods under 20-25 lines when possible. If a method is longer, extract into private methods or dedicated helper classes. Each method should be easily understandable at a glance.

6. **Modularity**: Organize code into logical modules and packages. Related functionality should be grouped together in classes using domain-driven design principles.
...
2. **Identify Issues**: Look for:
 - Long methods or functions (>25 lines)
...
4. **Execute Incrementally**: Make one type of change at a time:
 ...
 - Third: Extract duplicate code into reusable classes or methods (prefer classes)
 - Fourth: Apply early returns to reduce nesting
 - Fifth: Split large methods into smaller ones or extract to helper classes
...
- Include type hints for all public method and API signatures
...
- Have meaningful method, class, and variable names
- Be testable (or more testable than before)
- Maintain or improve performance
- Include docstrings for complex public methods
